...
export const updateKaryawan  = (id, body)   => api.put(`/karyawan/${id}`, body)

// ── ABSENSI ───────────────────────────────
export const getAbsensi      = (tanggal)    => api.get('/absensi', { params: { tanggal } })
export const getAbsensiBulan = (id, b, t)   => api.get(`/absensi/${id}/bulan`, { params: { bulan: b, tahun: t } })
export const postAbsensi     = (body)       => api.post('/absensi', body)

// ── PASANG ────────────────────────────────
export const getPasang       = (tanggal)    => api.get('/pasang', { params: { tanggal } })
export const postPasang      = (body)       => api.post('/pasang', body)

// ── BONUS ─────────────────────────────────
export const getBonus        = (id, b, t)   => api.get('/bonus', { params: { karyawan_id: id, bulan: b, tahun: t } })
export const postBonus       = (body)       => api.post('/bonus', body)

// ── GAJI ──────────────────────────────────
export const getGaji         = (id, b, t)   => api.get(`/gaji/${id}`, { params: { bulan: b, tahun: t } })

// ── JABATAN ───────────────────────────────
export const getJabatan      = ()           => api.get('/jabatan')
export const createJabatan   = (body)       => api.post('/jabatan', body)
export const updateJabatan   = (id, body)   => api.put(`/jabatan/${id}`, body)
...
export const updateShift = (id, body)   => api.put(`/shift/${id}`, body)
...
// Helper format rupiah — dipakai di semua halaman
