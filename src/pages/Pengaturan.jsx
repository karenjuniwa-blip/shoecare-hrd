...
import { useNavigate } from 'react-router-dom' // 👈 FIX: Kembalikan import navigate
...
export default function Pengaturan() {
  const navigate = useNavigate() // 👈 FIX: Pasang di posisi yang benar
  const { changePin, isAdmin } = useAdmin() // 👈 FIX: Gabungkan useAdmin
  ...
  // ── FIX: LOGIKA GEMBOK PIN YANG BENAR UNTUK PENGATURAN ──
  if (showPin) {
    return (
      <>
